	...
	<div class="wrapper">
		<table width="100%">
			<tr>
				...
				Telah diterima dari Pengadilan Agama Sekayu kepada bpk/ibu A.n <strong><?= $akta->akta_cerai_nama ?> </strong> tanggal <strong> <?= date('d-m-Y') ?> </strong> berupa dokumen Akta Cerai No <strong> <?= $akta->akta_cerai_nomor ?> </strong> ,KTP No <strong> <?= $akta->akta_cerai_no_ktp ?> </strong> dan KK No <strong> <?= $akta->akta_cerai_no_kk ?> </strong>.
				</td>
			</tr>
		</table>
	</div>
		...
		<table width="100%">
			<tr>
				...
				<p>Sekayu, <?=  date('d F Y'); ?></p>
					...
					<?= $akta->akta_cerai_nama ?> <br> <br><br> <br><br>
				</td>
			</tr>
		</table>
