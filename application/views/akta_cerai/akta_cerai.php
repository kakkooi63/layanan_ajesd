        ...
        <div class="iq-card">
          <div class="iq-card-header d-flex justify-content-between">
            <div class="iq-header-title">
              <h4 class="card-title">Antar Jemput Sidang Difabel</h4>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" value="persidangan" name="jenis_layanan">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="tab-content" id="pills-tabContent-1">
              <div class="tab-pane fade show active" id="pills-home-fill" role="tabpanel" aria-labelledby="pills-home-tab-fill">
                ...
                <?php if ($token['role'] == ROLE_AKSES['OPERATOR_DUKCAPIL']) :  ?>
                  <textarea class="form-control" id="keterangan" placeholder="Tulis disini Keterangan / Alasan Jika Ditolak" name="keterangan"></textarea>
                <?php endif; ?>
              </div>
